...
- **Opened:** 2026-08-08
- **Closed:** 2026-08-14
- **Successor:** none; design work on the shell's glass reopens under a future checkpoint
...
| PANEL-1-Z | `celestina:` | done | [inventory](../../inventories/2026-08-08-panel-glass-redesign/PANEL-1-Z.numstat.tsv) | 25 files, +1686/-1563 | Close this plan over the units it never returned to, and release the implementation checkpoint | [closure record](../../evidence/2026-08-14-panel-glass-closure.md) | `VAL-PANEL-1` |

## What PANEL-1-Z stands for

Seven units — `PANEL-1-I` through `PANEL-1-O` — were written as intent,
delivered as code across 0.11.0 to 0.14.1, and never returned to as ledger
rows. `PANEL-1-Z` closes the plan over them rather than reconstructing seven
inventories against base revisions chosen in hindsight, which would produce
documents that look like evidence and are not. Their subjects and their
delivery are traced through the version history and this project's dated
evidence records; the
[closure record](../../evidence/2026-08-14-panel-glass-closure.md) names each
one and the release it landed in.

Everything the plan received after that decomposition — the reading menus, the
quiet surfaces on the shell's glass, the physical arrival and departure of the
falling drop, one contextual surface at a time, and the dense glass's own blur,
across 0.15.0 to 0.19.0 — went further than the ledger ever described. The
plan is closed acknowledging that, not pretending otherwise.
