# Replacing Noctalia — execution plan (archived)

> Archived on 2026-08-03. Current implementation status lives in
> [`../../ROADMAP.md`](../../ROADMAP.md), current manual checks in
> [`../../VALIDATION.md`](../../VALIDATION.md), and active work in
> [`../plans/active/`](../plans/active/).
>
> **This entire file is non-normative history.** Any sentence below that calls
> itself canonical, active or an instruction was superseded by the 2026-08-03
> governance migration. Current decisions live in [`../decisions/`](../decisions/)
> and open questions in [`../discussions/`](../discussions/).

> **Historical status lived in
> [the former roadmap](roadmap-through-2026-08-03.md)**, which owned the R0–R9 checklists
...
> The following statement is retained as original historical wording only:
> “Settled execution decisions, open decisions and their falsifiers live only
> in this file.” It no longer defines authority or current ownership.
>
...
1. Read, in this order: the root [`AGENTS.md`](../../../AGENTS.md) (mandatory suite
   ...
   boundary and its evidence matrix), [the historical roadmap](roadmap-through-2026-08-03.md) (state and
...
> Archival note (2026-08-03): this section preserves the original work-order
> wording. Its accepted defaults now live canonically in
> [`../decisions/0001-shell-execution-defaults.md`](../decisions/0001-shell-execution-defaults.md),
> and unresolved choices live in [`../discussions/`](../discussions/).
