# Celestina — suite roadmap (archived)

> Archived on 2026-08-03. Current suite implementation lives in
> [`../../ROADMAP.md`](../../ROADMAP.md), current state in
> [`../../STATUS.md`](../../STATUS.md), and author-only checks in
...
[project inventory](../../README.md#projects) section and each
