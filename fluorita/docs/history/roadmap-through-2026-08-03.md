# Fluorita roadmap — archived through 2026-08-03

> Historical implementation and evidence record. It is immutable context, not
> the current plan. See [the current roadmap](../../ROADMAP.md),
> [current status](../../STATUS.md) and [author validation](../../VALIDATION.md).
...
- [x] **Hand-written C++ where CXX-Qt cannot reach** — [`cpp/mpvvideoitem.cpp`](../../../celestina-rs/crates/fluorita-qt/cpp/mpvvideoitem.cpp)
