...
`0.6.2`, and `VIS-2`, the scroll and fold correction the author reported on
it, closed the same day at `0.6.3`. The next checkpoint opens with a new plan and the author's word.
