# Active Grafita plans

The active plan is
[GRA-H1 — Hardening after the monorepo audit](2026-09-26-hardening.md), the
checkpoint the project roadmap names. A dated plan is added here only when the
