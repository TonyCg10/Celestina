...
| MAG-P3-B | `magnetita:` | planned | `magnetita/qml/`, `magnetita/src/` | — | The desktop app shows the pairing QR | `qmllint`, app tests | None |
| MAG-P3-C | `magnetita:` | planned | `magnetita/docs/evidence/` | — | The real phone pairs and holds a session | evidence record | `VAL-MAG-11` |
