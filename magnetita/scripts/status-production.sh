...
production_status "$suite_root" magnetita \
    --installed "magnetita/target/release/magnetita=$prefix/bin/magnetita" \
    --installed "celestina-rs/target/release/magnetitad=$prefix/bin/magnetitad"
