...
const QML_FILES: &[&str] = &[
    ...
    "qml/components/GlassPill.qml",
    "qml/components/SidebarChevron.qml",
    "qml/components/SidebarInfo.qml",
    "qml/components/FavoriteBadge.qml",
    "qml/components/NavButton.qml",
    "qml/components/InfoPill.qml",
    "qml/components/DragScrollEdge.qml",
    "qml/components/SizeRow.qml",
    "qml/components/PropRow.qml",
    "qml/components/SearchBar.qml",
    "qml/components/RecentHeader.qml",
    "qml/components/TrashHeader.qml",
    "qml/components/TabStrip.qml",
    "qml/components/DetailsHeader.qml",
    "qml/components/BottomControls.qml",
    "qml/components/TopBar.qml",
    "qml/components/FolderRowDelegate.qml",
    "qml/components/FolderCellDelegate.qml",
    // Vistas compuestas.
