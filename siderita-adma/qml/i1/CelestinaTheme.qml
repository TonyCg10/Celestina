...
// Siderita I1 design tokens — the single source of truth for the look.
// Organized as a One UI 8.5 (desktop-adapted) system: a scale for radius,
// spacing, type, motion and glass, plus semantic colors. Values here are
// calibrated to the current I1 appearance; tune these to art-direct the look
...
QtObject {
    ...
    */
    ...
    // ── Glass ────────────────────────────────────────────────────────────
    // Backdrop-blur parameters (was: literals inside GlassSurface).
    ...
    readonly property string fallbackIconRoot:
        "qrc:/qt/qml/org/celestina/siderita/icons/"
